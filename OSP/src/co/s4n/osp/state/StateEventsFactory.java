...
public interface StateEventsFactory
{
	 ...
	 */
	public ArrayList< DomainEvent > getEventsFor( EntityState entityState, DataTransferObject dto );
	
	/**
	 * @param state
	 * @return The events required to get back to the last state 
	 */
	public ArrayList< DomainEvent > getFailoverEventsFor( EntityState entityState, DataTransferObject dto );
}
